        ...
        if st.button("🚀 Lancer le Processus S&OP Collaboratif", use_container_width=True):
            ...
            with col_log:
                ...
                try:
                    ...
                    t_finance = Task(description=f"Analyse profit: {txt_fin}.", agent=SOP.finance, expected_output="Analyse financière.")
                    t_final = Task(description="Plan S&OP Final. Arbitre selon la marge.", agent=SOP.orchestrator, expected_output="Rapport S&OP Stratégique.")
